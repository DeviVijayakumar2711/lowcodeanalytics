...
def get_secret_debug(key, default_value=None):
    value = None
    try:
        ...
        if default_value is not None:
            value = default_value
        pass # Keep silent for UI, but could log to console for dev
    return value

OPENAI_API_KEY    = get_secret_debug("OPENAI_API_KEY")
AZURE_DEPLOYMENT  = get_secret_debug("AZURE_DEPLOYMENT")
AZURE_ENDPOINT    = get_secret_debug("AZURE_ENDPOINT")
AZURE_API_VERSION = get_secret_debug("AZURE_API_VERSION", "2024-02-15-preview") # Updated to a stable version
